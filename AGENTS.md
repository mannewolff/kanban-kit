...
- **Neu im Projekt?** Lies diese Datei + [Codex-workflow.md](.Codex/Codex-workflow.md).
...
- **Plan-Mode / Git / Issue-Workflow?** → [Codex-workflow.md](.Codex/Codex-workflow.md)
...
| [Codex-react.md](Codex-react.md) | React 18, Vite, TypeScript, MUI, Lazy Loading, ESLint/A11y | ✅ Allgemein |
| [Codex-security.md](Codex-security.md) | Spring Security, JPA, Frontend-XSS, Secrets, Session-/Token-Handling | ✅ Allgemein |
| [Codex-workflow.md](.Codex/Codex-workflow.md) | 9-Schritte-Workflow, Issues, Git, Pflichtchecks | ✅ Allgemein |
...
Verfahren, Reporting-Format und detaillierte Schritte → [Codex-workflow.md](.Codex/Codex-workflow.md).
