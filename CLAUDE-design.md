...
| `/projects/:projectId/nachtlauf` | Läufe | Verbrauchs-Bereich (Zeitraum-Sicht) nach `docs/mockup-nachtlauf-verbrauch.html` und Laufblöcke nach `docs/mockup-nachtlauf-lauf.html`, beide in Kupferwarte; der übrige Inhalt **Ausnahme Nachtlauf** (eigener Abschnitt); Rahmen der Vorlage | #978, #987, #988 |
