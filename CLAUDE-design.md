...
**Die Anwendung ist der KI-Leitstand 2.0, kein Kanban-Board mit Zusatzseite** (Manne, 2026-09-16). Das Board bleibt ein wichtiger Bestandteil; der Kern ist der Leitstand mit den detaillierten, verdichteten Informationen über die KI-Arbeit (Runs, Durchsatz, Verbrauch, Abbrüche, Vorhaben). Kennzahlen des bisherigen Dashboards wie die **Verweildauer je Spalte** sind dagegen unwichtig und gehören nicht in den Leitstand.
...
| Ebene | Radius | Token |
|---|---|---|
| Platte, Kachel, Band des jüngsten Runs, Spalte | 14 px | `PANEL_RADIUS` (`--r-gross`) |
...
- **Leitstand** (Entwurf CSS Z. 390–722, 977–1017; HTML Z. 1200–1678) — die Hauptansicht der Anwendung, nicht eine Statistikseite neben dem Board. Das Band des jüngsten Runs mit LED, Stufen, Zeit und Kosten; Kennzahl-Kacheln mit Wert, Einheit, Sparkline, Delta und Basis; Verbrauch mit Zeitraum-Wahl und Stapelbalken; Platten „Letzter Run", „Durchsatz", „Abbruchgründe", „Vorhaben" (die Platte „Liegengeblieben" der Vorlage entfällt, siehe [Vorlage und Abnahme](#vorlage-und-abnahme)).
...
| `/plattform-leitstand` | Plattform-Leitstand | Kupferwarte aus den Bausteinen des Leitstands (`LeitstandBausteine.tsx`, `KupferwarteBereich`, `Platte`, `Led`, `Taste`); drei Bereiche in dieser Ordnung: Aktive Runs, Beendete Runs, Störungen; der Entwurf führt für diese Ansicht kein eigenes Mockup | #1083, #1102 |
