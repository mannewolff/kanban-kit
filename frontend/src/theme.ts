 ...
 * `CLAUDE-design.md` (Zeile 58) — 3:1 für bedeutungstragende Grafikelemente, nicht 4,5:1 für Text.
 ...
 * gegen alle drei Flächen des Leitstands, aber nicht mehr 4,5:1. Gemessen gegen die drei
 * tatsächlichen Flächen (Weiß, {@link SURFACE_TINT}, {@link ICE}); `theme.test.ts` rechnet sie nach.
 *
