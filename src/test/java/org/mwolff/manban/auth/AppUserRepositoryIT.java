 ...
 * ab: Flyway migriert fehlerfrei (Kontext startet und Hibernate validiert die Entity gegen das
 * migrierte Schema), ein Repository liest/schreibt eine Tabelle, und die Seed-Matrix in {@code
...
class AppUserRepositoryIT extends AbstractIntegrationTest {
  ...
  void savesAndReadsAppUser() {
    AppUser saved =
        users.save(
            new AppUser(
                null, "alice@example.com", "argon2-hash", "Alice", false, PlatformRole.USER));
