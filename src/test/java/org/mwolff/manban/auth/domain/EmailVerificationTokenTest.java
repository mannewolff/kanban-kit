...
/** Verhaltenstests der Ablauf-/Einlöse-Logik eines {@link EmailVerificationToken}. */
class EmailVerificationTokenTest {

    private static final Instant EXPIRES = Instant.parse("2026-01-02T03:04:05Z");

    private static EmailVerificationToken token(Instant usedAt) {
        return new EmailVerificationToken(1L, 7L, "hash", EXPIRES, usedAt);
    }
