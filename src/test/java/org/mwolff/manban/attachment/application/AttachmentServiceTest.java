...
class AttachmentServiceTest {
    ...
    void setUp() {
        ...
        service = new AttachmentService(attachments, storage, detector, properties, cards, boards, permissions, clock);
    }
    ...
    void upload_throwsLimitExceeded_whenCardAtCapacity() {
        ...
        service = new AttachmentService(attachments, storage, detector, properties, cards, boards, permissions,
    ...
    void list_mapsAttachmentsToViews() {
        ...
        // Then
        assertThat(views).singleElement().extracting(AttachmentService.AttachmentView::filename).isEqualTo("note.txt");
    }
