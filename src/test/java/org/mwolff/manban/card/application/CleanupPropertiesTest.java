...
class CleanupPropertiesTest {
  ...
  void appliesDefaults_whenAllValuesNull() {
    // When
    CleanupProperties props = new CleanupProperties(null, null, null, null);

    // Then
    assertThat(props.enabled()).isTrue();
    assertThat(props.doneRetentionDays()).isEqualTo(30);
    assertThat(props.trashRetentionDays()).isEqualTo(30);
  ...
  void clampsNonPositiveDaysAndBlankCronToDefaults() {
    // When
    CleanupProperties props = new CleanupProperties(true, 0, 0, "   ");
  ...
  void keepsProvidedValues() {
    // When
    CleanupProperties props = new CleanupProperties(false, 14, 21, "0 0 2 * * *");

    // Then
    assertThat(props.enabled()).isFalse();
    assertThat(props.doneRetentionDays()).isEqualTo(14);
    assertThat(props.trashRetentionDays()).isEqualTo(21);
