...
public class AttachmentService {
    ...
    public Download download(long userId, long attachmentId) {
        ...
        return new Download(attachment.filename(), attachment.contentType(), attachment.size(),
    ...
    private static AttachmentView view(Attachment a) {
        return new AttachmentView(a.id(), a.cardId(), a.filename(), a.contentType(), a.size(), a.createdAt());
    }
