...
/**
 * {@link ObjectStorage} auf Basis von MinIO. Der Ziel-Bucket wird faul beim ersten
 * Zugriff angelegt (nicht beim Start), sodass Kontexte ohne Anhang-Nutzung keinen
 * Objektspeicher benötigen.
 */
@Component
