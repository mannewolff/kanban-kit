...
/**
 * Content-Type-Erkennung mit Apache Tika aus den Magic-Bytes des Inhalts (und dem Dateinamen als
 * Hinweis). Bewusst NICHT dem vom Client gemeldeten Typ vertrauen.
 */
@Component
