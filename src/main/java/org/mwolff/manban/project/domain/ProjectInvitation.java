...
/**
 * Einladung einer E-Mail-Adresse in ein Projekt mit vorgesehener Rolle. Persistiert
 * wird nur der Token-Hash; das Klartext-Token geht per E-Mail an die eingeladene Person.
 *
