...
/**
 * Stellt die feste Rollen-Rechte-Matrix bereit — Quelle der Wahrheit für die {@code /roles}-Ansicht.
 * Nur die Anzeige; die Matrix selbst ist statisch geseedet (konfigurierbar erst mit 2.0).
 */
@RestController
