...
/**
 * Auflösungsergebnis eines eingehenden {@code X-Kanban-Token}: der Besitzer plus die
 * optionale Projekt-/Board-Bindung. Wird vom {@code PatAuthenticationFilter} an die
 * Authentication-{@code details} gehängt, damit die Kanban-Compat-API (#45) das
 * gebundene Board ohne zweiten Token-Lookup kennt.
 *
