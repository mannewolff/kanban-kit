 ...
 * @param sessionSecret   HMAC-Geheimnis zum Signieren des Session-Cookies. In Produktion
 *                        zwingend über die Umgebung setzen (stabil über Neustarts/Instanzen).
 * @param sessionTtl      Gültigkeitsdauer eines Session-Cookies
 * @param cookieSecure    ob das Session-Cookie das Secure-Flag trägt (Default true; hinter
 *                        Caddy-TLS korrekt. Nur für lokalen Klartext-HTTP-Dev auf false setzen.)
 */
