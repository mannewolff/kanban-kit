...
/**
 * Registriert einen neuen Benutzer: legt ihn (unverifiziert) mit Argon2id-Passwort-Hash
 * an, erzeugt ein Verifikations-Token und stößt den Versand der Verifikations-E-Mail an.
 */
@Service
