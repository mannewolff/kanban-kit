...
/**
 * Baut und liest das Session-Cookie. HttpOnly (XSS-sicher), {@code SameSite=Strict}
 * (das Cookie wird nie cross-site gesendet — die CSRF-Absicherung für den zustandslosen
 * Cookie-Ansatz), Secure konfigurierbar (hinter Caddy-TLS an).
 */
@Component
