 ...
 *
 * <p>Kein Server-Session-Store nötig; die Gültigkeit ergibt sich aus Signatur + Ablauf.
 * Der Signaturschlüssel muss über Neustarts/Instanzen stabil sein (siehe AuthProperties).
 */
@Component
